...
protected:
    GenericSensorCmd(ModuleControl* module, uint8_t index, Sensor_Type_e type, std::array<AIn_Num_t, 4> ain_pins);
    int16_t getInt16(uint8_t eventId, uint8_t callbackId);
    float getFloat(uint8_t eventId, uint8_t callbackId);
...
{
public:
    RawSensorCmd(ModuleControl* module, uint8_t index, Sensor_Type_e type, std::array<AIn_Num_t, 4> ain_pins) : GenericSensorCmd(module, index, type, ain_pins) {}
    void setParameter(Sensor_Parameter_e parameter, Sensor_Parameter_Value_u value);
...
{
public:
    RTDCmd(ModuleControl* module, uint8_t index, Sensor_Type_e type, std::array<AIn_Num_t, 4> ain_pins) : GenericSensorCmd(module, index, type, ain_pins) {}
    void setParameter(Sensor_Parameter_e parameter, Sensor_Parameter_Value_u value);
...
{
public:
    ThermocoupleCmd(ModuleControl* module, uint8_t index, Sensor_Type_e type, std::array<AIn_Num_t, 4> ain_pins) : GenericSensorCmd(module, index, type, ain_pins) {}
    void setParameter(Sensor_Parameter_e parameter, Sensor_Parameter_Value_u value);
    float readMillivolts(void);
    float readTemperature(void);
};
...
{
public:
    StrainGaugeCmd(ModuleControl* module, uint8_t index, Sensor_Type_e type, std::array<AIn_Num_t, 4> ain_pins) : GenericSensorCmd(module, index, type, ain_pins) {}
    void setParameter(Sensor_Parameter_e parameter, Sensor_Parameter_Value_u value);
...
public:
    ...
    AnalogInputsLSCmd(ModuleControl* module) : _module(module) {}
