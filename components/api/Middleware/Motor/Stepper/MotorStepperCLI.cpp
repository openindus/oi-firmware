...
void MotorStepperCLI::_registerLimitSwitch(void)
{
...
void MotorStepperCLI::_registerStepResolution(void)
{
...
void MotorStepperCLI::_registerSetMaxSpeed(void)
{
...
void MotorStepperCLI::_registerGetPosition(void)
{
...
void MotorStepperCLI::_registerGetSpeed(void)
{
...
void MotorStepperCLI::_registerStop(void)
{
...
void MotorStepperCLI::_registerMoveAbsolute(void)
{
...
void MotorStepperCLI::_registerMoveRelative(void)
{
...
void MotorStepperCLI::_registerRun(void)
{
...
void MotorStepperCLI::_registerHoming(void)
{
