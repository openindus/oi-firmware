...
int StepperCmdHandler::init()
{
    ...
    ControllerSlave::addCmdHandler(REQUEST_MOTOR_ATTACH_LIMIT_SWITCH,
    ...
    ControllerSlave::addCmdHandler(REQUEST_MOTOR_DETACH_LIMIT_SWITCH,
                                   [](std::vector<uint8_t> &data) {
                                       MotorNum_t motor = static_cast<MotorNum_t>(data[1]);
                                       DIn_Num_t din    = static_cast<DIn_Num_t>(data[2]);
    ...
    ControllerSlave::addCmdHandler(REQUEST_MOTOR_SET_FULL_STEP_SPEED,
                                   [](std::vector<uint8_t> &data) {
                                       MotorNum_t motor = static_cast<MotorNum_t>(data[1]);
                                       float *speed     = reinterpret_cast<float *>(&data[2]);
    ...
    ControllerSlave::addCmdHandler(REQUEST_MOTOR_RESET_HOME_POSITION,
                                   [](std::vector<uint8_t> &data) {
                                       MotorNum_t motor = static_cast<MotorNum_t>(data[1]);
    ...
    ControllerSlave::addCmdHandler(REQUEST_MOTOR_SET_POSITION, [](std::vector<uint8_t> &data) {
        MotorNum_t motor   = static_cast<MotorNum_t>(data[1]);
