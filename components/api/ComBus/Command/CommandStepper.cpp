...
CommandStepper::CommandStepper(Controller* control) : _control(control) 
{
...
void CommandStepper::attachLimitSwitch(MotorNum_t motor, DIn_Num_t din, Logic_t logic)
{
...
void CommandStepper::detachLimitSwitch(MotorNum_t motor, DIn_Num_t din)
{
    std::vector<uint8_t> msgBytes = {REQUEST_MOTOR_DETACH_LIMIT_SWITCH, (uint8_t)motor, (uint8_t)din};
    _control->request(msgBytes);
}

void CommandStepper::setStepResolution(MotorNum_t motor, MotorStepResolution_t res)
{
    std::vector<uint8_t> msgBytes = {REQUEST_MOTOR_SET_STEP_RESOLUTION, (uint8_t)motor, (uint8_t)res};
    _control->request(msgBytes);
}

void CommandStepper::setAcceleration(MotorNum_t motor, float acc)
{
...
void CommandStepper::setDeceleration(MotorNum_t motor, float dec)
{
    std::vector<uint8_t> msgBytes = {REQUEST_MOTOR_SET_ACCELERATION, (uint8_t)motor};
...
void CommandStepper::setMaxSpeed(MotorNum_t motor, float speed)
{
...
void CommandStepper::setMinSpeed(MotorNum_t motor, float speed)
{
...
void CommandStepper::setFullStepSpeed(MotorNum_t motor, float speed)
{
...
int32_t CommandStepper::getPosition(MotorNum_t motor)
{
...
float CommandStepper::getSpeed(MotorNum_t motor)
{
...
void CommandStepper::resetHomePosition(MotorNum_t motor)
{
    std::vector<uint8_t> msgBytes = {REQUEST_MOTOR_RESET_HOME_POSITION, (uint8_t)motor};
    _control->request(msgBytes);
}

void CommandStepper::stop(MotorNum_t motor, MotorStopMode_t mode)
{
    std::vector<uint8_t> msgBytes = {REQUEST_MOTOR_STOP, (uint8_t)motor, (uint8_t)mode};
    _control->request(msgBytes);
}

void CommandStepper::moveAbsolute(MotorNum_t motor, uint32_t position, bool microStep)
{
...
void CommandStepper::moveRelative(MotorNum_t motor, int32_t position, bool microStep)
{
...
void CommandStepper::run(MotorNum_t motor, MotorDirection_t direction, float speed)
{
...
void CommandStepper::homing(MotorNum_t motor, float speed)
{
