...
ControlCmd_Stepper::ControlCmd_Stepper(ControlCmd* control) : _control(control) 
{
...
void ControlCmd_Stepper::attachLimitSwitch(MotorNum_t motor, DIn_Num_t din, Logic_t logic)
{
...
void ControlCmd_Stepper::detachLimitSwitch(MotorNum_t motor, DIn_Num_t din)
{
    std::vector<uint8_t> msgBytes = {REQUEST_MOTOR_DETACH_LIMIT_SWITCH, (uint8_t)motor, (uint8_t)din};
    _control->request(msgBytes);
}

void ControlCmd_Stepper::setStepResolution(MotorNum_t motor, MotorStepResolution_t res)
{
    std::vector<uint8_t> msgBytes = {REQUEST_MOTOR_SET_STEP_RESOLUTION, (uint8_t)motor, (uint8_t)res};
    _control->request(msgBytes);
}

void ControlCmd_Stepper::setAcceleration(MotorNum_t motor, float acc)
{
...
void ControlCmd_Stepper::setDeceleration(MotorNum_t motor, float dec)
{
    std::vector<uint8_t> msgBytes = {REQUEST_MOTOR_SET_ACCELERATION, (uint8_t)motor};
...
void ControlCmd_Stepper::setMaxSpeed(MotorNum_t motor, float speed)
{
...
void ControlCmd_Stepper::setMinSpeed(MotorNum_t motor, float speed)
{
...
void ControlCmd_Stepper::setFullStepSpeed(MotorNum_t motor, float speed)
{
...
int32_t ControlCmd_Stepper::getPosition(MotorNum_t motor)
{
...
float ControlCmd_Stepper::getSpeed(MotorNum_t motor)
{
...
void ControlCmd_Stepper::resetHomePosition(MotorNum_t motor)
{
    std::vector<uint8_t> msgBytes = {REQUEST_MOTOR_RESET_HOME_POSITION, (uint8_t)motor};
    _control->request(msgBytes);
}

void ControlCmd_Stepper::stop(MotorNum_t motor, MotorStopMode_t mode)
{
    std::vector<uint8_t> msgBytes = {REQUEST_MOTOR_STOP, (uint8_t)motor, (uint8_t)mode};
    _control->request(msgBytes);
}

void ControlCmd_Stepper::moveAbsolute(MotorNum_t motor, uint32_t position, bool microStep)
{
...
void ControlCmd_Stepper::moveRelative(MotorNum_t motor, int32_t position, bool microStep)
{
...
void ControlCmd_Stepper::run(MotorNum_t motor, MotorDirection_t direction, float speed)
{
...
void ControlCmd_Stepper::wait(MotorNum_t motor)
{
    // Add callback
...
void ControlCmd_Stepper::homing(MotorNum_t motor, float speed)
{
