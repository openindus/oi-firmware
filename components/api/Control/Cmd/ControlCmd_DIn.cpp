...
int ControlCmd_DIn::digitalRead(DIn_Num_t num)
{
...
void ControlCmd_DIn::attachInterrupt(DIn_Num_t num, IsrCallback_t callback, InterruptMode_t mode)
{
...
void ControlCmd_DIn::detachInterrupt(DIn_Num_t num)
{
