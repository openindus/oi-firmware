...
/* DOUT_Sensors */
#define MIXED_CHANNEL_DOUT_CURRENT_1      ADC1_CHANNEL_3
#define MIXED_CHANNEL_DOUT_CURRENT_2      ADC1_CHANNEL_2
#define MIXED_CHANNEL_DOUT_CURRENT_3      ADC1_CHANNEL_1
#define MIXED_CHANNEL_DOUT_CURRENT_4      ADC1_CHANNEL_0
