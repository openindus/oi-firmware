...
void CommandAInLV::analogInputMode(AnalogInput_Num_t num, AnalogInput_Mode_t mode)
{
    std::vector<uint8_t> msgBytes = {REQUEST_ANALOG_INPUT_MODE, (uint8_t)num, (uint8_t)mode};
    _control->request(msgBytes);
}

uint8_t CommandAInLV::analogInputGetMode(AnalogInput_Num_t num)
{
...
void CommandAInLV::analogInputVoltageRange(AnalogInput_Num_t num, AnalogInput_VoltageRange_t range)
{
    std::vector<uint8_t> msgBytes = {REQUEST_ANALOG_INPUT_VOLTAGE_RANGE, (uint8_t)num, (uint8_t)range};
    _control->request(msgBytes);
}

uint8_t CommandAInLV::analogInputGetVoltageRange(AnalogInput_Num_t num)
{
...
int CommandAInLV::analogRead(AnalogInput_Num_t num)
{
...
float CommandAInLV::analogReadVolt(AnalogInput_Num_t num)
{
...
float CommandAInLV::analogReadMilliVolt(AnalogInput_Num_t num)
{
...
float CommandAInLV::analogReadAmp(AnalogInput_Num_t num)
{
...
float CommandAInLV::analogReadMilliAmp(AnalogInput_Num_t num)
{
