...
void BusCtrlCmd_AInLV::analogInputMode(AnalogInput_Num_t num, AnalogInput_Mode_t mode)
{
    std::vector<uint8_t> msgBytes = {REQUEST_ANALOG_INPUT_MODE, (uint8_t)num, (uint8_t)mode};
    _control->request(msgBytes);
}

uint8_t BusCtrlCmd_AInLV::analogInputGetMode(AnalogInput_Num_t num)
{
...
void BusCtrlCmd_AInLV::analogInputVoltageRange(AnalogInput_Num_t num, AnalogInput_VoltageRange_t range)
{
    std::vector<uint8_t> msgBytes = {REQUEST_ANALOG_INPUT_VOLTAGE_RANGE, (uint8_t)num, (uint8_t)range};
    _control->request(msgBytes);
}

uint8_t BusCtrlCmd_AInLV::analogInputGetVoltageRange(AnalogInput_Num_t num)
{
...
int BusCtrlCmd_AInLV::analogRead(AnalogInput_Num_t num)
{
...
float BusCtrlCmd_AInLV::analogReadVolt(AnalogInput_Num_t num)
{
...
float BusCtrlCmd_AInLV::analogReadMilliVolt(AnalogInput_Num_t num)
{
...
float BusCtrlCmd_AInLV::analogReadAmp(AnalogInput_Num_t num)
{
...
float BusCtrlCmd_AInLV::analogReadMilliAmp(AnalogInput_Num_t num)
{
