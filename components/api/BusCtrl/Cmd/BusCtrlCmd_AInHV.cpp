...
float BusCtrlCmd_AInHV::analogRead(AnalogInput_Num_t num)
{
...
float BusCtrlCmd_AInHV::analogReadVolt(AnalogInput_Num_t num)
{
...
float BusCtrlCmd_AInHV::analogReadMilliVolt(AnalogInput_Num_t num)
{
