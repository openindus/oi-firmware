...
int CLI_BusControl::_registerProgramCmd(void)
{
...
int CLI_BusControl::_registerPingCmd(void)
{
...
int CLI_BusControl::_registerAutoIdCmd(void)
{
    const esp_console_cmd_t cmd = {
        .command = "auto-id",
...
int CLI_BusControl::_registerDiscoverSlavesCmd(void)
{
    const esp_console_cmd_t cmd = {
...
int CLI_BusControl::_registerGetSlaveInfoCmd(void)
{
...
int CLI_BusControl::_registerStopCmd(void)
{
    const esp_console_cmd_t cmd = {
        .command = "stop",
...
int CLI_BusControl::_registerStartCmd(void)
{
    const esp_console_cmd_t cmd = {
        .command = "start",
...
#if defined(MODULE_MASTER)
    state = Master::getStatus();
#elif defined(MODULE_SLAVE)
    state = Slave::getStatus();
#else 
...
int CLI_BusControl::_registerGetStatusCmd(void)
{
    const esp_console_cmd_t cmd = {
        .command = "status",
