...
public:
    ...
    {
        Slave::addRequestProcessCallback(REQUEST_MOTOR_ATTACH_LIMIT_SWITCH, [](std::vector<uint8_t> &data) {
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_DETACH_LIMIT_SWITCH, [](std::vector<uint8_t> &data) {
            MotorNum_t motor = static_cast<MotorNum_t>(data[1]);
            DIn_Num_t din    = static_cast<DIn_Num_t>(data[2]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_SET_STEP_RESOLUTION, [](std::vector<uint8_t> &data) {
                MotorNum_t motor          = static_cast<MotorNum_t>(data[1]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_SET_ACCELERATION, [](std::vector<uint8_t> &data) {
            MotorNum_t motor = static_cast<MotorNum_t>(data[1]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_SET_DECELERATION, [](std::vector<uint8_t> &data) {
            MotorNum_t motor = static_cast<MotorNum_t>(data[1]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_SET_MAX_SPEED, [](std::vector<uint8_t> &data) {
            MotorNum_t motor = static_cast<MotorNum_t>(data[1]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_SET_MIN_SPEED, [](std::vector<uint8_t> &data) {
            MotorNum_t motor = static_cast<MotorNum_t>(data[1]);
            float *speed     = reinterpret_cast<float *>(&data[2]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_SET_FULL_STEP_SPEED, [](std::vector<uint8_t> &data) {
            MotorNum_t motor = static_cast<MotorNum_t>(data[1]);
            float *speed     = reinterpret_cast<float *>(&data[2]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_GET_POSITION, [](std::vector<uint8_t> &data) {
            MotorNum_t motor = static_cast<MotorNum_t>(data[1]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_GET_SPEED, [](std::vector<uint8_t> &data) {
            MotorNum_t motor = static_cast<MotorNum_t>(data[1]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_RESET_HOME_POSITION, [](std::vector<uint8_t> &data) {
            MotorNum_t motor = static_cast<MotorNum_t>(data[1]);
            MotorStepper::resetHomePosition(motor);
            data.clear();
        });

        Slave::addRequestProcessCallback(REQUEST_MOTOR_SET_POSITION, [](std::vector<uint8_t> &data) {
            MotorNum_t motor  = static_cast<MotorNum_t>(data[1]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_STOP, [](std::vector<uint8_t> &data) {
            MotorNum_t motor         = static_cast<MotorNum_t>(data[1]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_MOVE_ABSOLUTE, [](std::vector<uint8_t> &data) {
            MotorNum_t motor   = static_cast<MotorNum_t>(data[1]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_MOVE_RELATIVE, [](std::vector<uint8_t> &data) {
            MotorNum_t motor   = static_cast<MotorNum_t>(data[1]);
            uint32_t *position = reinterpret_cast<uint32_t *>(&data[2]);
            bool microStep     = static_cast<bool>(data[6]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_RUN, [](std::vector<uint8_t> &data) {
            MotorNum_t motor           = static_cast<MotorNum_t>(data[1]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_WAIT, [](std::vector<uint8_t> &data) {
            MotorNum_t motor = static_cast<MotorNum_t>(data[1]);
            char task_name[14];
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_HOMING, [](std::vector<uint8_t> &data) {
            MotorNum_t motor = static_cast<MotorNum_t>(data[1]);
            float *speed     = reinterpret_cast<float *>(&data[2]);
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_SET_ADVANCED_PARAM, [](std::vector<uint8_t> &data) {
        ...
        Slave::addRequestProcessCallback(REQUEST_MOTOR_GET_ADVANCED_PARAM, [](std::vector<uint8_t> &data) {
