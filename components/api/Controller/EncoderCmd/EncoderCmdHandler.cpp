...
int EncoderCmdHandler::init(Encoder** encoder)
{
    ...
    Slave::addRequestProcessCallback(REQUEST_ENCODER_BEGIN, [](std::vector<uint8_t> &msgBytes) {
    ...
    Slave::addRequestProcessCallback(REQUEST_ENCODER_END, [](std::vector<uint8_t> &msgBytes) {
        int instance = msgBytes[1];
        if (_encoder[instance] != nullptr) {
    ...
    Slave::addRequestProcessCallback(REQUEST_ENCODER_RESET, [](std::vector<uint8_t> &msgBytes) {
        int instance = msgBytes[1];
        if (_encoder[instance] != nullptr) {
    ...
    Slave::addRequestProcessCallback(REQUEST_ENCODER_GET_REVOLUTIONS, [](std::vector<uint8_t> &msgBytes) {
        int instance = msgBytes[1];
        if (_encoder[instance] != nullptr) {
    ...
    Slave::addRequestProcessCallback(REQUEST_ENCODER_GET_PULSES, [](std::vector<uint8_t> &msgBytes) {
        int instance = msgBytes[1];
        if (_encoder[instance] != nullptr) {
    ...
    Slave::addRequestProcessCallback(REQUEST_ENCODER_GET_ANGLE, [](std::vector<uint8_t> &msgBytes) {
        int instance = msgBytes[1];
        if (_encoder[instance] != nullptr) {
    ...
    Slave::addRequestProcessCallback(REQUEST_ENCODER_GET_SPEED, [](std::vector<uint8_t> &msgBytes) {
        int instance = msgBytes[1];
        if (_encoder[instance] != nullptr) {
