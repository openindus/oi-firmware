...
int AnalogInputsLSCmdHandler::init(void)
{
    ...
    Slave::addRequestProcessCallback(REQUEST_ADD_SENSOR, [](std::vector<uint8_t>& data) {
    ...
    Slave::addRequestProcessCallback(REQUEST_SENSOR_SET_PARAMETER, [](std::vector<uint8_t>& data) {
    ...
    Slave::addRequestProcessCallback(REQUEST_SENSOR_READ, [](std::vector<uint8_t>& data) {
    ...
    Slave::addRequestProcessCallback(REQUEST_SENSOR_READ_MILLIVOLT, [](std::vector<uint8_t>& data) {
    ...
    Slave::addRequestProcessCallback(REQUEST_SENSOR_READ_RESISTANCE, [](std::vector<uint8_t>& data) {
    ...
    Slave::addRequestProcessCallback(REQUEST_SENSOR_READ_TEMPERATURE, [](std::vector<uint8_t>& data) {
    ...
    Slave::addRequestProcessCallback(REQUEST_SENSOR_READ_RAW, [](std::vector<uint8_t>& data) {
