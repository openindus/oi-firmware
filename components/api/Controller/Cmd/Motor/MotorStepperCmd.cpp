...
MotorStepperCmd::MotorStepperCmd(Controller* controller) : _controller(controller)
{
...
int MotorStepperCmd::setAdvancedParam(MotorNum_t motor, AdvancedParameter_t advParam, void* value)
{
    ...
    return _controller->performRequest(REQUEST_MOTOR_SET_ADVANCED_PARAM, args);
}
...
int MotorStepperCmd::getAdvancedParam(MotorNum_t motor, AdvancedParameter_t advParam, void* value)
{
    ...
    int ret = _controller->performRequest(REQUEST_MOTOR_GET_ADVANCED_PARAM, args);
    if (ret == 0) {
