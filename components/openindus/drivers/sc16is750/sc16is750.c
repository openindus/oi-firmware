...
//Private variables
static void SC16IS750_isr_handler(void* arg);
static void SC16IS750_task(void* arg);
static TaskHandle_t intrTaskHandle;
...
void SC16IS750_send_break() 
{
    ...
    esp_rom_delay_us((18000000/_config.baudrate));
...
static IRAM_ATTR void SC16IS750_isr_handler(void* arg)
{
