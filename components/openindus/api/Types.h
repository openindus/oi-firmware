...
enum Callback_e {
    ...
    /* DC MOTOR (PID CTRL) */
    CALLBACK_MOTOR_DC_PID_CTRL_ATTACH_ENCODER   = 0xA6,
    CALLBACK_MOTOR_DC_PID_CTRL_DETACH_ENCODER   = 0xA7,
    CALLBACK_MOTOR_DC_PID_CTRL_MOVE_TO          = 0xA8,
    CALLBACK_MOTOR_DC_PID_CTRL_STOP             = 0xA9,
    CALLBACK_MOTOR_DC_PID_CTRL_GET_POSITION     = 0xAA,
    CALLBACK_MOTOR_DC_PID_CTRL_SET_PARAMS       = 0xAB,
    CALLBACK_MOTOR_DC_PID_CTRL_HOMING           = 0xAC,
