...
{
    std::vector<uint8_t> msgBytes = {CALLBACK_ANALOG_INPUT_MODE, (uint8_t)num, (uint8_t)mode};
    _module->runCallback(msgBytes);
}

uint8_t AnalogInputsLVCmd::analogInputGetMode(AnalogInput_Num_t num)
{
    std::vector<uint8_t> msgBytes = {CALLBACK_ANALOG_INPUT_GET_MODE, (uint8_t)num};
    _module->runCallback(msgBytes);
    return msgBytes[2];
}
...
{
    std::vector<uint8_t> msgBytes = {CALLBACK_ANALOG_INPUT_VOLTAGE_RANGE, (uint8_t)num, (uint8_t)range};
    _module->runCallback(msgBytes);
}

uint8_t AnalogInputsLVCmd::analogInputGetVoltageRange(AnalogInput_Num_t num)
{
    std::vector<uint8_t> msgBytes = {CALLBACK_ANALOG_INPUT_GET_VOLTAGE_RANGE, (uint8_t)num};
    _module->runCallback(msgBytes);
    return msgBytes[2];
}
...
{
    std::vector<uint8_t> msgBytes = {CALLBACK_ANALOG_READ, (uint8_t)num};
    _module->runCallback(msgBytes);
...
{
    std::vector<uint8_t> msgBytes = {CALLBACK_ANALOG_READ_VOLT, (uint8_t)num};
    _module->runCallback(msgBytes);
...
{
    std::vector<uint8_t> msgBytes = {CALLBACK_ANALOG_READ_MILLIVOLT, (uint8_t)num};
    _module->runCallback(msgBytes);
    float* ret = reinterpret_cast<float*>(&msgBytes[2]);
    return *ret;
}
...
{
    std::vector<uint8_t> msgBytes = {CALLBACK_ANALOG_READ_AMP, (uint8_t)num};
    _module->runCallback(msgBytes);
    float* ret = reinterpret_cast<float*>(&msgBytes[2]);
    return *ret;
}
...
{
    std::vector<uint8_t> msgBytes = {CALLBACK_ANALOG_READ_MILLIAMP, (uint8_t)num};
    _module->runCallback(msgBytes);
    float* ret = reinterpret_cast<float*>(&msgBytes[2]);
    return *ret;
}
